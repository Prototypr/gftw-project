...
The website (or front-end) is the part of the app people will visit with a web browser. It's built with [NextJS](https://nextjs.org/), reading data from a [headless CMS backend: Strapi](./back-end). This section will show you how it was set up from the NextJS Starter boilerplate. 
